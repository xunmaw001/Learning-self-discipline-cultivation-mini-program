		...
		<view class="container">
				...
				<swiper-item v-for="(swiper,index) in swiperList" :key="index">
					...
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.nianling}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>手机：</view>
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.shouji}}</view>
				</view>
                				                				<view class="detail-list-item" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0 0 2rpx 0","borderColor":"#fff","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"140rpx","fontSize":"28rpx","color":"#333","textAlign":"right"}'>邮箱：</view>
					<view class="text" :style='{"color":"#333","textAlign":"right","fontSize":"28rpx"}'>{{detail.youxiang}}</view>
				</view>
